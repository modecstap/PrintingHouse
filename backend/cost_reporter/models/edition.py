...
class Edition(BaseModel):
    count: int = Field(description="Кол-во изделий шт.")
    list_size: ListSize = Field(description="Формат листа")
    density: int = Field(description="Плотность бумаги в гр./м^2")
    ...
    markup: Decimal = Field(description="Наценка (1.85 - наценка в 85%)")
